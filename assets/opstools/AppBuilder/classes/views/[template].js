 ...
 * ABView[template]
 *
 * An ABView[template] defines a [template] view type.
 *
 */
...
var ABView[template]PropertyComponentDefaults = {
...
export default class ABView[template] extends ABViewWidget  {
	...
	editorComponent(App, mode) {
		...
		var idBase = 'ABView[template]EditorComponent';
		var ids = {
	...
	component(App) {
		...
		var idBase = 'ABView[template]_'+this.id;
		var ids = {
			component: App.unique(idBase+'_component'),
		}
