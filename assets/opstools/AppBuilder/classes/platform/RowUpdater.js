    ...
    constructor(App, idBase) {
        ...
        var labels = {
            ...
            component: {
                ...
                setOption1: L(
                    "ab.component.form.recordrule.set.customValue",
                    "*to a custom value"
                ),
                setOption2: L(
                    "ab.component.form.recordrule.set.formValue",
                    "*to a form value"
                ),
                setOption3: L(
                    "ab.component.form.recordrule.set.connectedValue",
