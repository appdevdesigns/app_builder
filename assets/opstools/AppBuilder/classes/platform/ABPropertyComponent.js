...
module.exports = class ABPropertyComponent {
   ...
   component(App) {
      ...
      var _init = function() {
         ...
         if (this.init != _init) this.init(ids);
      };
      ...
      var _logic = {
         ...
         onChange: (newVal, oldVal) => {
            ...
            if (
               !this.isPopulating &&
               typeof this.currentObject != "undefined"
            ) {
               _logic.busy();
         ...
         populate: (editedObject) => {
            ...
            this.EditObject.propertyEditorPopulate(
               App,
               ids,
               editedObject,
               _logic
      ...
      var elements = this.EditObject.propertyEditorDefaultElements(
         App,
         ids,
         _logic,
         this.fieldDefaults
