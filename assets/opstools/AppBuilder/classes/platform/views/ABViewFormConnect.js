    ...
    static populateBadgeNumber(ids, view) {
        if (
            ...
            $$(ids.buttonFilter).define(
                "badge",
                view.settings.objectWorkspace.filterConditions.rules.length ||
                    null
            );
    ...
    component(App) {
        ...
        component.logic = {
            ...
            goToEditPage: (rowId) => {
                ...
                let editForm = this.application.urlResolve(
