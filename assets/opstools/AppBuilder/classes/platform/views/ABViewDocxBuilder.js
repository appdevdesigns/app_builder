                    ...
                    rows: [
                        {
                            ...
                            view: "text",
                            label: L(
                                "ab.components.docxBuilder.text",
                                "*Label"
                            ),
...

                        {
                            ...
                            name: "width",
                            label: L(
                                "ab.components.docxBuilder.width",
                                "*Width:"
                            ),
                            labelWidth: App.config.labelWidthXLarge
                        },
