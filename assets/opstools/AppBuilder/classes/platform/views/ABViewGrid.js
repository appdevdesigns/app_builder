...
module.exports = class ABViewGrid extends ABViewGridCore {
        ...
        return commonUI.concat([
            {
                view: "fieldset",
                label: L(
                    "ab.component.label.gridProperties",
                    "*Grid Properties:"
                ),
    ...
    static propertyUpdateGridFilterObject(ids, view) {
        ...
        if (selectedDv) {
            ...
            if (object) {
                PopupFilterProperty.objectLoad(
                    object,
                    selectedDv.settings.loadAll
                );
            }
        }
    }
            ...
            if (this.settings.dataviewID != "") {
                ...
                if (
                    ...
                    (this.settings.gridFilter &&
                        ...
                        this.settings.gridFilter.userFilterPosition ==
                            "toolbar")
                ) {
                    $$(ids.toolbar).show();
                }
                ...
                if (dv && dv.datasource) {
                    ...
                    PopupMassUpdateComponent.objectLoad(
                        CurrentObject,
                        DataTable
                    );
                ...
                rows: [
                    {
                        ...
                        cols: [
                            ...
                            },
                            {
                                ...
                                css: "webix_transparent",
                                label: L(
                                    "ab.object.toolbar.filterFields",
                                    "*Filters"
                                ),
                                icon: "fa fa-filter",
                                type: "icon",
