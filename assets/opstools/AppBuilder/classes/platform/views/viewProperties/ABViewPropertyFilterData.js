                    ...
                    if (RulesUI) {
                        ...
                        Rule.init({
                            onDelete: (deletedRule) => {
                                $$(ids.filterRules).removeView(
                                    Rule.ids.component
                                );

                                var index = instance.queryRules.indexOf(
                                    deletedRule
                                );
                                if (index !== -1) {
                    ...
                    cols: [
                        ...
                        },
                        {
                            ...
                            click: function () {
                                ...
                                $$(ids.globalFilterForm).callEvent(
                                    "onTimedKeyPress"
                                );
                            }
                        }
