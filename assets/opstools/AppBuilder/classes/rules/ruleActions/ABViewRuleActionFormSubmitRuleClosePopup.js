...
export default class ABViewRuleActionFormSubmitRuleClosePopup extends ABViewRuleAction {
	...
	constructor(App, idBase) {
		...
		this.label = L('ab.component.ruleaction.abviewruleActionFormSubmitRuleClosePopup', '*Close the current popup');
	...
	process(options) {
		...
		return new Promise((resolve, reject) => {
			...
			let pageDomId = ['ab_live_page', popup.application.id, popup.id].join('_');
