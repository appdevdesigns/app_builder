...
module.exports = class ABViewRuleActionObjectUpdater extends ABViewRuleAction {
    ...
    constructor(App, idBase, currentForm) {
        ...
        this.label = L(
            "ab.component.ruleaction.updateRecord",
            "*Update Record"
        );
            ...
            addRow: (data) => {
                ...
                if (
                    ...
                    rows.filter((r) => {
                        return r.queryView(function(view) {
                            return (
                                view.config.name == "field" && !view.getValue()
                            );
                        });
                    }).length > 0
                )
                            ...
                            cols: [
                                {
                                    ...
                                    placeholder: this.labels.component
                                        .chooseSource,
                                    on: {
                                        onChange: (newv, oldv) => {
