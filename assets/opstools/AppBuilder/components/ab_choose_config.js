    ...
    constructor(App) {
        ...
        var labels = {
            ...
            component: {
                ...
                buttonCreateRelayUser: L(
                    "ab.config.createRelayUser",
                    "*Create Relay User"
                ),
                buttonUpdatePublicServer: L(
                    "ab.config.updatePublicServer",
                    "*Update Public Server"
                ),

                selectQRUsers: L(
                    "ab.config.selectQRUsers",
                    "*Select Relay User"
                ),
                selectQRApp: L(
                    "ab.config.selectQRApp",
                    "*Select Relay Application"
                ),
                buttonSendQREmail: L("ab.config.sendQREmail", "*Send QR Email"),

                selectQRVersion: L(
                    "ab.config.selectQRVersion",
                    "*Select App Version"
                ),
                versionDevelop: L("ab.config.versionDevelop", "*Develop"),
                versionStaging: L("ab.config.versionStaging", "*Staging"),
                versionProduction: L(
                    "ab.config.versionProduction",
                    "*Production"
                ),
                versionNSApp: L("ab.config.versionNSApp", "*NS App"),

                confirmUsersCreated: L(
                    "ab.config.confirmUsersCreated",
                ...
                confirmUsersPublished: L(
                    "ab.config.confirmUsersPublished",
                    "*Users successfully published"
                ),
                errorUsersPublished: L(
                    "ab.config.errorUsersPublished",
                    "*Error publishing users."
                ),

                confirmQRSent: L("ab.config.confirmQRSent", "*QR Email Sent"),
                errorQRSent: L(
                    "ab.config.errorQRSent",
                    "*Error sending QR email"
                ),

                errorQRCode: L(
                    "ab.config.errorQRCode",
                    "*Error retrieving user's QR code."
                ),

                createNew: L(
                    "ab.application.createNew",
                    "*Add new application"
                ),
                noApplication: L(
                ...
                buttonSendConfirmationEmails: L(
                    "ab.config.sendConfirmationEmails",
                    "*Send Confirmation Emails"
                ),
                confirmEmailsSent: L(
                    "ab.config.confirmEmailsSent",
                    "*Confirmation Emails Sent"
                ),
                errorEmailsSent: L(
                    "ab.config.errorEmailsSent",
                    "*Error Sending Confirmation Emails"
                ),

                buttonSendFeeConfirmationEmails: L(
                    "ab.config.sendConfirmationEmails",
                    "*Send Fee Confirmation Emails"
                ),
                confirmFeeEmailsSent: L(
                    "ab.config.confirmEmailsSent",
                    "*Fee Confirmation Emails Sent"
                ),
                errorFeeEmailsSent: L(
                    "ab.config.errorEmailsSent",
                    "*Error Sending Fee Confirmation Emails"
                )
            }
        };
                        ...
                        //
                        {
                            ...
                            rows: [
                                // Create Relay User:
                                {
                                    view: "template",
                                    template:
                                        labels.component.buttonCreateRelayUser,
                                    type: "header",
                                ...
                                // Send QR Email:
                                {
                                    view: "template",
                                    template:
                                        labels.component.buttonSendQREmail,
                                    type: "header",
                                    css: "bg-gray webix_header"
                                },
                                {
                                    ...
                                    rows: [
                                        {
                                            ...
                                            view: "multicombo",
                                            label:
                                                labels.component.selectQRUsers,
                                            labelWidth:
                                                App.config.labelWidthXXLarge,
                                            minWidth: 800,
                                            value: "",
        ...
        var _logic = {
                ...
                if (names != "") {
                    ...
                    OP.Comm.Service.post({
                        ...
                        .catch((err) => {
                            _logic.ready();
                            OP.Error.log(
                                labels.component.errorUsersCreated,
                                err
                            );
                        });
                }
             ...
             */
            ready: function() {
                if ($$(ids.rows).hideProgress) $$(ids.rows).hideProgress();
            },
