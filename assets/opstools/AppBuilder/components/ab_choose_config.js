                  ...
                  //
                  {
                     ...
                     rows: [
                           ...
                           rows: [
                              ...
                              },
                              {
                                 ...
                                 options: [
                                    {
                                       id: "D",
                                       value: labels.component.versionDevelop
                                    },
                                    {
                                       id: "S",
                                       value: labels.component.versionStaging
                                    },
                                    {
                                       id: "P",
                                       value: labels.component.versionProduction
                                    },
                                    {
                                       id: "N",
                                       value: labels.component.versionNSApp
                                    }
                                 ],
                                 on: {
                                    onChange: function(newVal, oldVal) {
                        ...
                        // Button: Send Confirmation Emails
                        {
                           view: "template",
                           template:
                              labels.component.buttonSendConfirmationEmails,
                           type: "header",
                           css: "bg-gray webix_header"
                        },
                        {
                        ...
                        // Button: Send Fee Confirmation Emails
                        {
                           view: "template",
                           template:
                              labels.component.buttonSendFeeConfirmationEmails,
                           type: "header",
                           css: "bg-gray webix_header"
                        },
                        {
