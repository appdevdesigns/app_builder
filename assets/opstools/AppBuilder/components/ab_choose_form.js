                        ...
                        },
                        {
                            ...
                            elements: [
                                //{ type: "section", template: '<span class="webix_icon fa fa-edit" style="max-width:32px;"></span>Information', margin: 0 },
                                {
                                    ...
                                    placeholder:
                                        labels.component.placeholderName,
                                ...
                                { height: App.config.smallSpacer },
                                {
                                    ...
                                    labelWidth: 100,
                                    placeholder:
                                        labels.component.placeholderDescription,
                                    height: 100
                                },
                                { height: App.config.smallSpacer },
                                {
                                ...
                                { height: App.config.smallSpacer },
                                {
                                    ...
                                    cols: [
                                        ...
                                        },
                                        {
                                            ...
                                            label:
                                                labels.component.createNewRole,
                                            on: {
