    ...
    constructor(App) {
        ...
        var labels = {
            ...
            component: {
                ...
                connections: L(
                    "ab.object.external.connections",
                    "*Connections"
                ),
        ...
        var _logic = (this._logic = {
            ...
            filter: function() {
                ...
                $$(ids.externalList).filter(
                    (externalModel) =>
                        externalModel.name.toLowerCase().indexOf(filterText) >
                        -1
                );
            },
            ...
            externalSelect: () => {
                ...
                if (selectedExternal) {
                    ...
                    var tableName =
                        selectedExternal.name || selectedExternal.id;
                    ...
                    this.abExternal.tableColumns(tableName, connName).then(
                        (attrs) => {
                            Object.keys(attrs).forEach((attrName) => {
                                ...
                                if (
                                    ABField.reservedNames.indexOf(attrName) > -1
                                )
                                    return;
