...
var idBase = 'ab_common_popupEditMenu';
OP.Component.extend(idBase, function (App) {
	...
	var ids = {
		menu: App.unique(idBase + '_menu')+webix.uid(),
		list: App.unique(idBase + '_list')+webix.uid()
	}
	...
	var _init = function (options) {
		...
		Popup = webix.ui(_ui);	// the current instance of this editor.
	...
	return {
		...
		menuOptions: _logic.menuOptions,
		show: _logic.show,
