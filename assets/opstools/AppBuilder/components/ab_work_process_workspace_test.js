/*
 * ab_work_object_workspace_test
 *
 * Manage the Object Workspace area.
 *
 */

export default class ABWorkProcessWorkspaceTest extends OP.Component {
    /**
     * @param {object} App
     * @param {string} idBase
     */
    constructor(App, idBase) {
        idBase = idBase || "ab_work_process_workspace_test";
        ...
        var labels = {
            common: App.labels,
            component: {
                label: L("ab.process.test.label", "*Test")
            }
        };
