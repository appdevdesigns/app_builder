                        ...
                        rows: [
                            ...
                            },
                            {
                                ...
                                body: {
                                    ...
                                    minHeight: 300,
                                    template: (obj, common) => {
                                        return this._logic.templateListItem(
                                            obj,
                                            common
                                        );
                                    },
        ...
        return {
            ...
            applicationLoad: (application) => {
                ...
                datasources.unshift({
                    id: "",
                    value: L(
                        "ab.datacollection.selectSource",
                        "*Select a source"
                    )
                });
                ...
                var addPage = (page, index, parentId) => {
                    ...
                    page.views((v) => !(v instanceof ABViewTab)).forEach(
                        (widgetView, widgetIndex) => {
                    ...
                    page.views((v) => v instanceof ABViewTab).forEach(
                        (tab, tabIndex) => {
                            ...
                            tab.views().forEach((tabView, tabViewIndex) => {
                                ...
                                var tIndex =
                                    subPages.length + tabIndex + tabViewIndex;
            ...
            save: () => {
                ...
                this._datacollection.settings.loadAll = $$(
                    ids.loadAll
                ).getValue();
            ...
            initLinkDatacollectionOptions: () => {
                ...
                if (objSource != null) {
                    ...
                    let linkObjectIds = linkFields.map(
                        (f) => f.settings.linkObject
                    );
            ...
            initLinkFieldOptions: (linkedDvId = null) => {
                ...
                let linkFieldId = linkFieldOptions[0]
            ...
            populatePopupEditors: () => {
                if (this._datacollection && this._datacollection.datasource) {
                    ...
                    this._datacollection.refreshFilterConditions(
                        filterConditions
                    );
            ...
            populateFixSelector: () => {
                ...
                if (this._datacollection && this._datacollection.datasource) {
                    ...
                    if (datasource) {
                        let userFields = datasource.fields(
                            (f) => f.key == "user"
                        );
            ...
            initPopupEditors: () => {
                ...
                this.FilterComponent = new RowFilter(
                    this.App,
                    `${idBase}_filter`
                );
                this.FilterComponent.applicationLoad(this._application);
