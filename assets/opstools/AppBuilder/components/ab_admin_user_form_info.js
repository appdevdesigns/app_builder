...
module.exports = class AB_Work_Admin_User_Form_Info extends ABComponent {
    constructor(App) {
        super(App, "ab_admin_user_form_info");
        ...
        this.ui = {
            rows: [
                {
                    template: `<span class='fa fa-user'></span> ${L(
                        "ab.admin.userInfo",
                        "*User Info"
                    )}`,
                    type: "header"
        ...
        let _logic = {
            cancel: () => {
                if (this._userDC) this._userDC.setCursor(null);
            },
            ...
            save: () => {
                ...
                // clear 'null' value
                for (let key in vals) {
                    if (vals[key] == null) delete vals[key];
                }
