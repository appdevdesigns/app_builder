    ...
    constructor(App) {
        ...
        var labels = {
            ...
            component: {
                ...
                separatedBy: L(
                    "ab.object.form.csv.separatedBy",
                    "*Separated by"
                ),
                headerFirstLine: L(
                            ...
                            dataType: function(obj, common) {
                                return {
                                    ...
                                    options: [
                                        {
                                            id: "string",
                                            value: ABFieldString.defaults()
                                                .menuName
                                        },
                                        {
                                            id: "LongText",
                                            value: ABFieldLongText.defaults()
                                                .menuName
                                        },
                                        {
                                            id: "number",
                                            value: ABFieldNumber.defaults()
                                                .menuName
                                        },
                                        {
                                            id: "date",
                                            value: ABFieldDate.defaults()
                                                .menuName
                                        },
                                        {
                                            id: "boolean",
                                            value: ABFieldBoolean.defaults()
                                                .menuName
                                        }
                                    ],
                                    width: 120
        ...
        var _logic = (this._logic = {
            ...
            loadCsvFile: (fileInfo) => {
                ...
                // read CSV file
                csvImporter
                    .getDataRows(fileInfo, getSeparatedBy())
                    .then((data) => {
                        dataRows = data;
                ...
                if ($$(ids.headerOnFirstLine).getValue()) {
                    columnList = firstLine.map(function(colName, index) {
                        return {
                            include: true,
                            columnName: colName,
                            dataType: csvImporter.getGuessDataType(
                                dataRows,
                                index
                            )
                        };
                ...
                _logic.callbacks.onSave(newObjAttr, (validator, newObj) => {
                    ...
                    dataRows.forEach((data, index) => {
                        subTasks = subTasks.then((x) => {
                            if (
                                $$(ids.headerOnFirstLine).getValue() &&
                                index == 0
                            )
