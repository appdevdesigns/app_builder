...
export default class ABWorkObjectPopupNewDataField extends OP.Component {
    ...
    constructor(App) {
        ...
        var ids = {
            ...
            types: this.unique('_types'),
            editDefinitions: this.unique('_editDefinitions'),
            buttonSave: this.unique('_buttonSave'),
            buttonCancel: this.unique('_buttonCancel')
        };
