...
describe("ab_work_object_list_newObject_csv component", () => {
   ...
   describe("UI testing", () => {
      ...
      it("should call .removeCsvFile when remove a uploaded file", () => {
         let uploadedFile = OP.Test.findElement(target.ui, {
               name: "uploadedFile"
            }),
            mockElem = {},
            mockId = "MOCK_FILE_ID",
      ...
      it("should call .populateColumnList when select separate item", () => {
         let separatedByList = OP.Test.findElement(target.ui, {
               name: "separatedBy"
            }),
            stubPopulateColumnList = sandbox.stub(
               target._logic,
               "populateColumnList"
            );
      ...
      it("should call .populateColumnList when check/uncheck header on first line option", () => {
         let headerOnFirstLine = OP.Test.findElement(target.ui, {
