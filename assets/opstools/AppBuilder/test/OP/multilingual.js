...
describe("OP.multilingual unit tests", () => {
   ...
   describe("OP.multilingual.translate", () => {
      ...
      it("should not alter the object if no translations are present", () => {
         ...
         assert.isUndefined(
            objNoTranslations.translations,
            " --> object not altered"
         );
         assert.isDefined(
            currObj.translations,
            " --> object should have translations property"
         );
      });
   ...
   describe("OP.multilingual.unTranslate", () => {
      ...
      it("should alter the object if no translations are present", () => {
         ...
         assert.isOk(
            found,
            " --> found a translation entry for the current language"
         );
      });
      ...
      it("should update an existing translation entry", () => {
         ...
         assert.notProperty(
            found,
            "field3",
            " --> non entries in fields array not created"
         );
