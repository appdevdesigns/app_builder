   ...
   describe("Image field test cases", () => {
      ...
      it(".setValue: should set valid HTML dom when data is set", () => {
         ...
         assert.equal(
            ...
            "should not display the Image icon"
         );
         assert.equal(
            "block",
            imageDeleteIcon.style.display,
         ...
         assert.equal(
            ...
            "should show Image name"
         );
         assert.equal(
            row[columnName],
            imagePanel.getAttribute("Image-uuid"),
            "should match"
         );
      });
      ...
      it(".setValue: should set valid HTML dom when data is empty", () => {
         ...
         assert.equal(
            "block",
            imageIcon.style.display,
            "should display the Image icon"
         );
         assert.equal(
            "none",
            imageDeleteIcon.style.display,
            "should not display remove icon"
         );

         assert.equal(
            "none",
            imagePanel.style.display,
            "should not display Image name"
         );
