      ...
      async.series(
         [
            ...
            function(next) {
               ...
               transform(
                  ...
                  .then(function(transform) {
                     ...
                     fs.writeFile(
                        path.join("opstools", "BuildApp", "production.js"),
                        main.code,
                        "utf8",
                        function(err) {
                           if (err) {
                              AD.log.error(
                                 "<red>could not write minified opstools/BuildApp JS file !</red>"
                              );
                              next(err);
                           }
                  ...
                  .catch(function(err) {
                     AD.log.error(
                        "<red>could not complete opstools/BuildApp JS build!</red>",
                        err
                     );
                     next(err);
                  });
            ...
            function(next) {
               ...
               transform(
                  ...
                  .then(function(transform) {
                     ...
                     fs.writeFile(
                        path.join("opstools", "BuildApp", "production.css"),
                        main.code,
                        "utf8",
                        function(err) {
                           if (err) {
                              AD.log.error(
                                 "<red>could not write minified opstools/BuildApp CSS file !</red>"
                              );
                              next(err);
                           }
                  ...
                  .catch(function(err) {
                     AD.log.error(
                        "<red>could not complete opstools/BuildApp CSS build!</red>",
                        err
                     );
                     next(err);
                  });
            ...
            function(next) {
               var patches = [
                  {
                     file: path.join("opstools", "BuildApp", "production.js"),
                     tag: "packages/OpsPortal-BuildApp.js",
