...
module.exports = {
   ...
   objectFindOne: function(req, res) {
      AppBuilder.routes.verifyAndReturnObject(req, res).then((object) => {
      ...
      Promise.resolve()
         ...
         .then(() => {
            return new Promise((next, error) => {
               ...
               if (object.tableName || !appID) return next();
               ...
               ABGraphApplication.findOne(appID)
                  ...
                  .then((app) => {
                     ...
                     // Set table name here
                     object.tableName = AppBuilder.rules.toObjectNameFormat(
         ...
         .then((obj) => {
            return new Promise((next, error) => {
               if (application == null) return next();
   ...
   excludeObject: function(req, res) {
      ...
      ABGraphObject.unrelate(ABGraphObject.relations.applications, appID, objID)
         .catch((err) => {
            res.AD.error(err);
         })
         .then(() => {
