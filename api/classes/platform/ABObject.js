                        ...
                        new Promise((next, err) => {
                            ...
                            if (!_.isEmpty(where)) {
                                ...
                                var parseCondition = (condition, Query) => {
                                    ...
                                    if (
                                        AppBuilder.rules.isUuid(condition.key)
                                    ) {
                                ...
                                var noRelationRules = (
                                    where.rules || []
                                ).filter((r) => r.rule == "have_no_relation");
