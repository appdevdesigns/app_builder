                            ...
                            ENTemplateDesign.create({
                                ...
                                .then((template) => {
                                    ...
                                    ENNotification.create({
                                        notificationTitle:
                                            app.label + "install info", // can be anything
        ...
        if (createParams["New Coach Email"] && !createParams["New Coach"]) {
            ...
            var task = Promise.resolve()
                .then(() => {
                    ...
                    return sdcObjectByID(
                        "83a364fb-e181-45a9-a8de-c9db674fe641"
                    );
                })
                .then((objHRISEmail) => {
                    if (!objHRISEmail) {
                        bailError(
                            "E_NOTFOUND",
                            "Could not find HRIS Email Object."
                        );
                        return;
                    }
                ...
                .then((emailRows) => {
                    ...
                    return sdcObjectByID(
                        "4759b063-67c6-4580-9c2e-fdede54ef51c"
                    );
                })
                .then((objStaff) => {
                    if (!objStaff) {
                        bailError(
                            "E_NOTFOUND",
                            `Could not find the Staff object.`
                        );
                        return;
                    }
